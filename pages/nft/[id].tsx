    ...
    <div className='flex h-screen flex-col lg:grid lg:grid-cols-10'>
        ...
        <div className='flex flex-1 flex-col p-12 lg:col-span-6'>
            ...
            <header className='flex items-center justify-between'>
                <Link href={'/'}>
                    <h1 className='w-52 cursor-pointer text-xl font-extralight sm:w-80'>The <span className='font-extrabold underline decoration-pink-600/50'> KINGSTON</span> NFT Market Place</h1>
                </Link>
            ...
            {/* Mint Button */}
            <button onClick={mintNft} disabled={loading || claimedSupply == totalSupply?.toNumber() || !address} className='mt-10 h-16 w-full rounded-full bg-red-600 text-white font-bold disabled:bg-gray-400'>
                {loading ? (
                    <>Loading</>
